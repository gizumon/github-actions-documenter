...
const runMain = () => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const result = `${markdown_1.newLine}${anchorDoc}${headerDoc}${ca}${rw}`;
...
const mdCommonHeader = () => {
    ...
    const note = (0, exports.mdNote)(`🚀 Generated automatically by [github-actions-documenter](${link}) 🚀${exports.newLine}` +
        `⚠️ This is a generated markdown file. Do not edit this file manually.${exports.newLine}`);
    return `${exports.divider}${exports.newLine}${note}`;
};
...
const mdAgenda = (yamlMap) => {
    const agendaItem = Object.keys(yamlMap).map((key, i) => {
        const num = i + 1;
        return `${(0, exports.mdLink)(`${num}: ${yamlMap[key].name}`, (0, helpers_1.toAnchorLink)(`${num}: ${yamlMap[key].name}`))} ( ${(0, exports.mdLink)('📄', key)} )`;
    });
